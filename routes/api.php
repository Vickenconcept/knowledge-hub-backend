...
use App\Http\Controllers\Core\Connectors\ManualUploadController;
use App\Http\Controllers\Core\Connectors\NotionController;
use App\Http\Controllers\Core\CostTrackingController;
use App\Http\Controllers\Core\BillingController;
use App\Http\Controllers\Core\SubscriptionController;
use App\Http\Controllers\Core\PricingTierController;
use App\Http\Controllers\Core\TeamController;
use App\Http\Controllers\Core\StripeWebhookController;
use App\Http\Controllers\Core\FeedbackController;
use App\Http\Controllers\Core\FeedbackDashboardController;
...
use App\Http\Controllers\Core\AdminOrganizationController;
...
Route::post('auth/login', [AuthController::class, 'login'])->middleware(TrackVisit::class);
...
Route::get('auth/validate', [AuthController::class, 'validateToken'])->middleware(TrackVisit::class);

// Explicit traffic tracking endpoint for landing/register/login pages (frontend can POST to this)
